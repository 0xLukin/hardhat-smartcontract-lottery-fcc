...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
  ...
  uint16 private constant REQUEST_CONFIRMATTIONS = 3;
  ...
  event WinnerPicaked(address indexed winner);
  ...
  function fulfillRandomWords(
    ...
    emit WinnerPicaked(recentWinner);
  }
